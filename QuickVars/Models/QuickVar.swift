...
/// SPEC.md §14 — serialized and encrypted together as QuickVar.encryptedMetadata.
...
/// `QuickVar.emergencyPayload`, sealed under a different, weaker-gated key
