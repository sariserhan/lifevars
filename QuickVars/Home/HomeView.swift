...
struct HomeView: View {
    ...
    /// Widgets/AskQuickVarsControl.swift's Control Center control.
    ...
    /// SPEC.md §3.2 — typed query with no match, offered as a new QuickVar name.
    ...
    private var firstQuickVarPrompt: some View {
        VStack(spacing: 16) {
