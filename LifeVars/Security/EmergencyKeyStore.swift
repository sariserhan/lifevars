...
///
/// Only items the user explicitly opts in (LifeVar.emergencyPayload) ever
/// touch this key. Every other LifeVar is completely unaffected and stays
...
final class EmergencyKeyStore {
    ...
    private let service = "com.serhansari.LifeVars"
