...
struct HowItWorksView: View {
    ...
    private let items: [Item] = [
        Item(
            ...
            body: "Authenticating once covers everything you do until LifeVars is backgrounded or you lock it manually — you're never re-prompted per item."
        ),
        Item(
        ...
        Item(
            ...
            body: "LifeVars guesses a category from the name you type. It's only ever a suggestion — change it any time from the dropdown in Add or Edit, and every item still lives in one flat, searchable list regardless of category."
        ),
        Item(
            icon: "textformat.123",
        ...
        Item(
            ...
            body: "Pick one item to pin, then add the LifeVars widget from your Lock Screen editor. It shows only a generic locked icon — never the name or value. Tapping it opens the app and still requires Face ID before revealing anything. Only one item can be pinned at a time; pinning a new one replaces the old pin."
        ),
        Item(
            icon: "applewatch",
            title: "Apple Watch",
        ...
        Item(
            icon: "mic",
            title: "\u{201C}Ask LifeVars to find something\u{201D}",
        ...
        Item(
            icon: "bolt.shield",
            title: "\u{201C}Ask LifeVars to check something\u{201D}",
