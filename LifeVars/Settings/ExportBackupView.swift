...
/// The one place a password (not Face ID) protects something in LifeVars —
        ...
        Task {
            do {
                ...
                let url = FileManager.default.temporaryDirectory
                    .appendingPathComponent("LifeVars-Backup-\(Int(Date().timeIntervalSince1970))")
                    .appendingPathExtension("lifevarsbackup")
